 ...
 * worker no arregla una dependencia caida.
 */
export const buildLiveness = (): HealthReport => ({ status: 'ok', checks: {} })

/**
 * Readiness: evalua las dependencias reales del worker. Nunca devuelve `ok`
 * de forma incondicional; una readiness falsa es peor que no tenerla.
 */
